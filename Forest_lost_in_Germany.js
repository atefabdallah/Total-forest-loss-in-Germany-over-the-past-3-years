...
// Load Hansen Global Forest Change dataset for 2020 and 2023
...
// Select the 'loss' bands for both years from the dataset
var loss_2020 = forest_cover_2020.select(['loss']);
var loss_2023 = forest_cover_2023.select(['loss']);

// Calculate the total forest loss between 2020 and 2023
var total_loss = loss_2023.and(loss_2020.not());

// Clip and mask the total forest loss to Germany's boundaries
var clipped_loss = total_loss.clip(Germany);

// Add the total forest loss layer to the map
